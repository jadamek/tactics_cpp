...
// - Set Size
//----------------------------------------------------------------------------
// * size : width, height of the menu's inner body
// Repositions and scales the menu frame to fit the inner body size
//----------------------------------------------------------------------------
void SpriteMenuFrame::setSize(const sf::Vector2u& size)
{
    size_ = size;
